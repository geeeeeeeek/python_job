...
class User(models.Model):
    ...
    job_role = models.CharField(max_length=2, blank=True, null=True)
...
class Resume(models.Model):
    ...
    cover = models.ImageField(upload_to='resume/', null=True)
    name = models.CharField(max_length=100, blank=True, null=True)
...
class Company(models.Model):
    ...
    title = models.CharField(max_length=100, blank=True, null=True)
    cover = models.ImageField(upload_to='company/', null=True)
    guimo = models.CharField(max_length=100, blank=True, null=True)
    hangye = models.CharField(max_length=100, blank=True, null=True)
...
class Thing(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, blank=True, null=True,
                             related_name='user_thing')
    company = models.ForeignKey(Company, on_delete=models.CASCADE, blank=True, null=True,
                                related_name='company_thing')
    ...
    work_expe = models.CharField(max_length=50, blank=True, null=True)
...
class Post(models.Model):
    ...
    thing = models.ForeignKey(Thing, on_delete=models.CASCADE, null=True,
                              related_name='thing_post')
    company = models.ForeignKey(Company, on_delete=models.CASCADE, null=True,
                                related_name='company_post')
    resume = models.ForeignKey(Resume, on_delete=models.CASCADE, null=True,
                                related_name='resume_post')
    create_time = models.DateTimeField(auto_now_add=True, null=True)
